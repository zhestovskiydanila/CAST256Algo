...
inline std::string padding(const std::string& src) {
...
inline std::string hash(const std::string& _src) {
	// for Step 2.
	_UINT64_T src_size;
	...
	_c.i = C;
	_d.i = D;
    char buf[17] = {(char)(_a.s[0]), (char)(_a.s[1]), (char)(_a.s[2]), (char)(_a.s[3]),
            (char)(_b.s[0]), (char)(_b.s[1]), (char)(_b.s[2]), (char)(_b.s[3]),
                    (char)(_c.s[0]), (char)(_c.s[1]), (char)(_c.s[2]), (char)(_c.s[3]),
                            (char)(_d.s[0]), (char)(_d.s[1]), (char)(_d.s[2]), (char)(_d.s[3])};
    buf[16] = '\0';
    return (std::string)buf;
}

inline int padding(const std::string *src, std::string* dst) {
	uint32_t m = src->length() % 64;
	uint32_t n = 56 - ((m > 56) ? (m - 64) : m);
	dst->assign(*src);
	dst->append(  1, 0x80);
...
inline void hash(const std::string* _src, std::string* dst) {
	// for Step 2.
	_UINT64_T src_size;
	src_size.i = _src->length() * BITS_PER_BYTE;
